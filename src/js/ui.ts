...
import {AUDIO, game, GAME_EXTEND_TIME, GAME_START_TIME} from './game';
import {addClass, removeClass} from './classes';
import {camera} from './camera';
import {share} from './share';
import {getQueryParam, isChromeIOS, isIOS, isMobile} from './utils';
...
const SELECTORS = {
    ...
    LIST_CATEGORIES: '.list__categories--js',
    ...
    STATUS_BAR_EMOJI_NAME_EL: '.view__status-bar__find__emoji__name--js',
...
export class Ui {
    ...
    statusBarEmojiNameEl: HTMLElement;
    ...
    constructor() {
        ...
        this.listCategories = document.querySelector(SELECTORS.LIST_CATEGORIES);
        ...
        this.statusBarEmojiNameEl =
            document.querySelector(SELECTORS.STATUS_BAR_EMOJI_NAME_EL);
    ...
    setActiveEmojiName(emojiName: string) {
        this.statusBarEmojiNameEl.innerText = emojiName;
    }
